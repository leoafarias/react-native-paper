...
const CrossFadeIcon = ({ color, size, source, theme }) => {
    ...
    return (React.createElement(View, { style: [
        ...
        previousIcon ? (React.createElement(Animated.View, { style: [
                styles.icon,
                {
                    opacity: opacityPrev,
            ...
            React.createElement(Icon, { source: previousIcon, size: size, color: color }))) : null,
        React.createElement(Animated.View, { style: [
            ...
            React.createElement(Icon, { source: currentIcon, size: size, color: color }))));
};
